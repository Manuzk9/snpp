...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\xampp\\htdocs\\mitienda\\modules\\productcomments\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\xampp\\htdocs\\mitienda\\modules\\productcomments\\src\\Entity/index.php']);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\xampp\\htdocs\\mitienda\\modules\\ps_checkout\\src\\Entity']);
        $f->addExcludePaths([0 => 'C:\\xampp\\htdocs\\mitienda\\modules\\ps_checkout\\src\\Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\xampp\\htdocs\\mitienda\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $c->addDriver($e, 'PrestaShop\\Module\\ProductComment\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\xampp\\htdocs\\mitienda\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\xampp\\htdocs\\mitienda', 'C:\\xampp\\htdocs\\mitienda/modules/');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\mitienda/var/cache/prod\\/localization'))));
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.1', 'C:\\xampp\\htdocs\\mitienda', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('8.1.1', 'C:\\xampp\\htdocs\\mitienda');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.project_dir' => 'C:\\xampp\\htdocs\\mitienda',
            'kernel.name' => 'app',
            'kernel.debug' => false,
